export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'aknmag',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Aknmag',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'aknmag.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://aknmag.com',
